...
export default function CalculatorSubtraction() {
            ...
            <div className="mt-4 mb-4 mx-4 d-flex justify-content-center align-items-center text-center">
                <div class="card color-custom-bg" style={{ width: '300px' }}>
                    <div class="card-header bg-primary">
                        <h3 className='text-center'><i className="fa-solid fa-calculator"></i> Subtraction</h3>
                    </div>
                    <div class="card-body">
                        <div className='text-center'>
                            ...
                            <span style={{ width: '74px', display: 'inline-block' }} className='text-center'><i class="fa-solid fa-minus"></i></span>
